import { defineComponent, useSSRContext, mergeProps, resolveComponent, withCtx, renderSlot, onMounted, onUnmounted, createVNode, openBlock, createBlock, createTextVNode, Fragment, renderList, toDisplayString, createCommentVNode, ref, withModifiers, withDirectives, vModelSelect, withKeys, vShow, createApp, h } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderSlot, ssrRenderComponent, ssrRenderTeleport, ssrRenderClass, ssrLooseContain, ssrGetDynamicModelProps, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseEqual } from "vue/server-renderer";
  ...
  _push(ssrRenderComponent(_component_app_layout, mergeProps({ title: "Publish new Config" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<select name="version" id="version" required class="block w-full py-2 pl-3 pr-10 mt-1 text-base border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"${_scopeId}><option value="v2"${ssrIncludeBooleanAttr(Array.isArray(_ctx.form.version) ? ssrLooseContain(_ctx.form.version, "v2") : ssrLooseEqual(_ctx.form.version, "v2")) ? " selected" : ""}${_scopeId}> Gibberish v2 </option><option value="v3"${ssrIncludeBooleanAttr(Array.isArray(_ctx.form.version) ? ssrLooseContain(_ctx.form.version, "v3") : ssrLooseEqual(_ctx.form.version, "v3")) ? " selected" : ""}${_scopeId}> Gibberish v3 </option></select></div><div class="mt-4"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "language",
          value: "Language"
        }, null, _parent2, _scopeId));
        ...
        _push2(`<select name="category_id" id="category" required class="block w-full py-2 pl-3 pr-10 mt-1 text-base border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"${_scopeId}><option${ssrIncludeBooleanAttr(Array.isArray(_ctx.form.category_id) ? ssrLooseContain(_ctx.form.category_id, null) : ssrLooseEqual(_ctx.form.category_id, null)) ? " selected" : ""}${_scopeId}>Chose a category</option><!--[-->`);
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "mt-4" }, [
                  ...
                  withDirectives(createVNode("select", {
                    name: "version",
                    id: "version",
                    "onUpdate:modelValue": ($event) => _ctx.form.version = $event,
                    required: "",
                    class: "block w-full py-2 pl-3 pr-10 mt-1 text-base border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                  }, [
                    createVNode("option", { value: "v2" }, " Gibberish v2 "),
                    createVNode("option", { value: "v3" }, " Gibberish v3 ")
                  ], 8, ["onUpdate:modelValue"]), [
                    [vModelSelect, _ctx.form.version]
                  ])
                ]),
                createVNode("div", { class: "mt-4" }, [
                  createVNode(_component_jet_label, {
  ...
  _push(ssrRenderComponent(_component_app_layout, { title: "All Configs" }, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</div><select name="version" id="version" class="block py-2 pl-3 pr-10 mt-1 text-base border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"${_scopeId}><option selected${ssrRenderAttr("value", null)} disabled${_scopeId}> Plugin Version </option><option value="v2"${ssrIncludeBooleanAttr(Array.isArray(_ctx.filters.version) ? ssrLooseContain(_ctx.filters.version, "v2") : ssrLooseEqual(_ctx.filters.version, "v2")) ? " selected" : ""}${_scopeId}> Gibberish v2 </option><option value="v3"${ssrIncludeBooleanAttr(Array.isArray(_ctx.filters.version) ? ssrLooseContain(_ctx.filters.version, "v3") : ssrLooseEqual(_ctx.filters.version, "v3")) ? " selected" : ""}${_scopeId}> Gibberish v3 </option></select><div class="items-center hidden space-x-5 md:flex"${_scopeId}>`);
            ...
            createVNode("div", { class: "mx-auto max-w-7xl sm:px-6 lg:px-8" }, [
              createVNode("div", { class: "flex items-center space-x-8" }, [
                ...
                withDirectives(createVNode("select", {
                  name: "version",
                  id: "version",
                  "onUpdate:modelValue": ($event) => _ctx.filters.version = $event,
                  ...
                  [vModelSelect, _ctx.filters.version]
                ]),
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_app_layout, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      var _a, _b;
      if (_push2) {
        _push2(`<div class="py-12"${_scopeId}><div class="mx-auto max-w-7xl sm:px-6 lg:px-8"${_scopeId}><div class="px-6 py-3 bg-white rounded dark:bg-slate-500"${_scopeId}><div class="lg:flex lg:items-center lg:justify-between"${_scopeId}><div class="flex-1 min-w-0"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate dark:text-white"${_scopeId}>${ssrInterpolate(_ctx.configuration.title)}</h2><span class="${ssrRenderClass([{
          "bg-red-100 text-red-700": _ctx.configuration.version === "v2",
          "bg-green-100 text-green-700": _ctx.configuration.version === "v3"
        }, "inline-flex items-center rounded-full px-4 py-2 font-bold"])}"${_scopeId}> Gibberish ${ssrInterpolate(_ctx.configuration.version)}</span></div><div class="flex flex-col mt-2 sm:flex-row sm:flex-wrap sm:space-x-6"${_scopeId}><div class="flex items-center mt-2 text-sm text-gray-500 dark:text-gray-300" title="Category"${_scopeId}><img class="flex-shrink-0 mr-1.5 h-6 w-6"${ssrRenderAttr("src", "/icons/" + _ctx.configuration.category.icon_path)}${ssrRenderAttr("alt", _ctx.configuration.category.title)}${_scopeId}> ${ssrInterpolate(_ctx.configuration.category.title)}</div><div class="flex items-center mt-2 text-sm text-gray-500 dark:text-gray-300" title="Author"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 mr-1.5 h-5 w-5 dark:text-gray-200 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"${_scopeId}></path></svg> ${ssrInterpolate(_ctx.configuration.user.username)}</div><div class="flex items-center mt-2 text-sm text-gray-500 uppercase dark:text-gray-300 dark:3ext-gray-100" title="Author"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 mr-1.5 h-5 w-5 dark:text-gray-200 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129"${_scopeId}></path></svg> ${ssrInterpolate(_ctx.configuration.language)}</div><div class="flex items-center mt-2 text-sm text-gray-500 dark:text-gray-300" title="Likes Count"${_scopeId}><svg class="flex-shrink-0 mr-1.5 h-5 w-5 dark:text-gray-200 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"${_scopeId}></path></svg> ${ssrInterpolate(((_a = _ctx.configuration.like_counter) == null ? void 0 : _a.count) || 0)}</div><div class="flex items-center mt-2 text-sm text-gray-500 dark:text-gray-300" title="Last updated on"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 mr-1.5 h-5 w-5 dark:text-gray-200 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId}></path></svg> ${ssrInterpolate(_ctx.formatDate(_ctx.configuration.updated_at))}</div><div class="flex items-center mt-2 text-sm text-gray-500 dark:text-gray-300" title="Likes Count"${_scopeId}><svg class="flex-shrink-0 mr-1.5 h-5 w-5 dark:text-gray-200 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 0 0-3.7-3.7 48.678 48.678 0 0 0-7.324 0 4.006 4.006 0 0 0-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 0 0 3.7 3.7 48.656 48.656 0 0 0 7.324 0 4.006 4.006 0 0 0 3.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3-3 3"${_scopeId}></path></svg> updated ${ssrInterpolate(_ctx.configuration.updated_count)} times </div></div></div></div><div class="pt-8 prose whitespace-pre dark:prose-invert dark:text-white"${_scopeId}>${_ctx.configuration.formatted_description}</div><div class="p-10"${_scopeId}><div class="flex items-center justify-end mb-4"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_action_message, {
          on: _ctx.copied,
          class: "mr-3"
        }, {
                ...
                createVNode("div", { class: "lg:flex lg:items-center lg:justify-between" }, [
                  createVNode("div", { class: "flex-1 min-w-0" }, [
                    createVNode("div", { class: "flex items-center justify-between" }, [
                      ...
                      }, " Gibberish " + toDisplayString(_ctx.configuration.version), 3)
                    ]),
                    createVNode("div", { class: "flex flex-col mt-2 sm:flex-row sm:flex-wrap sm:space-x-6" }, [
                      ...
                      createVNode("div", {
                        ...
                        createTextVNode(" updated " + toDisplayString(_ctx.configuration.updated_count) + " times ", 1)
                      ])
                    ])
                  ])
                ]),
