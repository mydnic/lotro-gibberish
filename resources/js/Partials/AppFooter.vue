      ...
      <div class="grid grid-cols-1 gap-8 mt-12 xl:mt-0 xl:col-span-2">
        <div class="md:grid md:grid-cols-2 md:gap-8">
          ...
          <div class="mt-12 md:mt-0">
            ...
            <ul role="list" class="mt-4 space-y-4">
              <li>
                <a href="https://www.lotrointerface.com/downloads/info1143-Gibberish.html" target="_blank" class="text-base text-gray-500 hover:text-gray-900"> Gibberish Plugin </a>
              </li>

              <li>
                <a href="https://www.youtube.com/watch?v=xwyCDJBlakI" target="_blank" class="text-base text-gray-500 hover:text-gray-900"> Plugin Tutorial </a>
              </li>

              <li>
                <a href="https://github.com/mydnic/lotro-gibberish" target="_blank" class="text-base text-gray-500 hover:text-gray-900"> Website's Github repo </a>
              </li>
            </ul>
          </div>
        </div>
