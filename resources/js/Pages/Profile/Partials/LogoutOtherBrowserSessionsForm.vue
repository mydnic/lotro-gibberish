<template>
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <UCard>
                ...
                <div class="flex items-center mt-5 gap-3">
                    <UButton @click="confirmLogout">
                        Log Out Other Browser Sessions
                    </UButton>

                    <span v-if="form.recentlySuccessful" class="text-sm text-gray-600 dark:text-gray-400">Done.</span>
                </div>
            </UCard>
        </div>
    </div>
    ...
    <UModal v-model:open="confirmingLogout" title="Log Out Other Browser Sessions" description="Please enter your password to confirm you would like to log out of your other browser sessions across all of your devices.">
        <template #body>
        ...
        <template #footer>
            <div class="flex justify-end gap-3">
                ...
                <UButton @click="logoutOtherBrowserSessions" :loading="form.processing" :disabled="form.processing">
                    Log Out Other Browser Sessions
                </UButton>
            </div>
        </template>
