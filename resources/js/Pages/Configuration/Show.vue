                ...
                <div class="lg:flex lg:items-center lg:justify-between">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex flex-col mt-2 sm:flex-row sm:flex-wrap sm:space-x-6">
                            <div class="flex items-center mt-2 text-sm text-gray-500" title="Category">
                                <img class="flex-shrink-0 mr-1.5 h-6 w-6 text-gray-400" :src="'/icons/' + configuration.category.icon_path" :alt="configuration.category.title">
                            ...
                            <div class="flex items-center mt-2 text-sm text-gray-500 uppercase" title="Author">
